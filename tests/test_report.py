"""
Tests for the Structured Video Report Generator (v0.50.0).
...
class TestReportGeneratorPipelineVersion:
    def test_custom_pipeline_version(self):
        generator = ReportGenerator(
            config=Config(data_dir=tempfile.mkdtemp()), pipeline_version="0.50.0"
        )
        index = VideoIndex(
            video_id="ver_test",
            filename="test.mp4",
        ...
        assert report.video.pipeline_version == "0.50.0"
