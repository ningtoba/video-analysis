...
|| `ADAPTIVE_SCALING_ENABLED` | `true` | Enable adaptive pipeline scaling — auto-tune quality/resolution per video (v0.60.0) |
|| `ADAPTIVE_SCALING_POLICY` | `auto` | Scaling policy: conservative, balanced, performance, or auto (v0.60.0) |
